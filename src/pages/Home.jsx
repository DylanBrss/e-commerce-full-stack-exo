...
const Home = () => {
    ...
    const [mobileProducts, setMobielProducts] = useState([])
                    ...
                    <Row>
                        <Col lg='6' md='6'>
                            <div className="hero__content">
                                ...
                                <h2>Make Your Inerior More Minimalistic & Modern</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing
                                    elit. Deleniti mollitia enim dicta! Totam, deleniti.
                                    Numquam incidunt repellat neque tempora laboriosam.</p>
                ...
                <Container>
                    <Row>
                        <Col lg='6' md='6'>
                            ...
                            <Clock />
                            <motion.button whileTap={{ scale: 1.2 }} className='buy__btn store__btn'><Link to='/shop'>Visite Store</Link></motion.button>
                        </Col>
